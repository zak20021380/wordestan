        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">WordConnect</span>
            </Link>
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated && user ? (
                <>
                  {/* Coins Display */}
                  <div className="flex items-center space-x-2 bg-glass-hover px-3 py-2 rounded-lg">
                  ...
                  <div className="relative">
                    <button className="flex items-center space-x-2 text-white hover:bg-glass-hover px-3 py-2 rounded-lg transition-colors">
                  ...
                  <button
                    onClick={logout}
                    className="flex items-center space-x-2 text-white/80 hover:text-white hover:bg-danger/20 px-3 py-2 rounded-lg transition-colors"
                  >
      ...
      <footer className="bg-glass backdrop-blur-lg border-t border-glass-border mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-white/60">
            <p>&copy; 2024 WordConnect Game. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
